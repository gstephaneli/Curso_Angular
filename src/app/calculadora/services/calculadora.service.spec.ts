...
describe('CalculadoraService', () => {
  ...
  it('Deve garantir que 1 * 5 + 1 = 6',
    inject([CalculadoraService],(service: CalculadoraService)=> {
    let multi_soma = service.calcular(service.calcular(1,5,CalculadoraService.MULTIPLICACAO),1,CalculadoraService.SOMA)
    expect(multi_soma).toEqual(6);   
